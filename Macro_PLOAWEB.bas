...
Sub Macro_PLOAWEB()
    ...
    Call TB_IMP_BLOQUEIO(7)
    Call TB_IMP_BLOQUEIO_NATUREZA(8)
    Call TB_IMP_DESTAQUE(9)
    Call TB_IMP_DESTAQUE_PTRES(10)
    Call TB_IMP_INDISPONIVEL(11)
    Call TB_IMP_LOA_DETALHADA(12)
    Call TB_IMP_RECEITAS(13)
    Call TB_IMP_HISTORICO_PGTO(14)
    Call TB_IMP_HISTORICO_PGTO2(15)
    Call TB_IMP_SRE_ADM(16)
    Call TB_IMP_PGTO(17)
    Call TB_IMP_RAP_EMPENHO(18)
    Call TB_IMP_LIMITE(19)
    Call TB_IMP_RECEBIDO(20)
    Call TB_IMP_RECEBIDO_PTRES(21)
    Call TB_IMP_RECEBIDO_RP(22)
    Call TB_IMP_CREDITOS(23)
    Call TB_IMP_UG_DESTAQUE(24)
    Call TB_IMP_NATUREZADETALHADA(25)
    Call TB_IMP_UGEXECUTORA(26)
    Call TB_IMP_DISPONIVELSRE(27)
    Call TB_IMP_CORFIN_NE_DIARIO(28)
    ...
    Call TB_IMP_NE_2021_1(38)
    Call TB_IMP_NE_2022_0(39)
    Call TB_IMP_NE_2022_1(40)
    Call JUNTARVALORESEXECUCAO(41)
    Call JUNTARVALORESEXECUCAOPTRES(42)
    Call JUNTARVALORESEXECUCAORP(43)
